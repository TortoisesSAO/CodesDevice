...
const ADCCC26XX_HWAttrs adcCC26xxHWAttrs[CONFIG_ADC_COUNT] = {
    /* adc_battery_level */
    {
        .adcDIO              = CONFIG_GPIO_adc_battery_level_AIN,
        .adcCompBInput       = ADC_COMPB_IN_AUXIO2,
        .refSource           = ADCCC26XX_FIXED_REFERENCE,
        .samplingDuration    = ADCCC26XX_SAMPLING_DURATION_1P37_MS,
    ...
    /* adc_5V_usb */
    {
        .adcDIO              = CONFIG_GPIO_adc_5V_usb_AIN,
    ...
    /* adc_battery_current */
    {
        .adcDIO              = CONFIG_GPIO_adc_battery_current_AIN,
...
const ADC_Config ADC_config[CONFIG_ADC_COUNT] = {
    /* adc_battery_level */
    {
        ...
        .object = &adcCC26xxObjects[adc_battery_level],
        .hwAttrs = &adcCC26xxHWAttrs[adc_battery_level]
    },
    /* adc_5V_usb */
    {
        .fxnTablePtr = &ADCCC26XX_fxnTable,
        .object = &adcCC26xxObjects[adc_5V_usb],
        .hwAttrs = &adcCC26xxHWAttrs[adc_5V_usb]
    },
    /* adc_battery_current */
    {
        .fxnTablePtr = &ADCCC26XX_fxnTable,
        .object = &adcCC26xxObjects[adc_battery_current],
        .hwAttrs = &adcCC26xxHWAttrs[adc_battery_current]
    },
};

const uint_least8_t adc_battery_level_CONST = adc_battery_level;
const uint_least8_t adc_5V_usb_CONST = adc_5V_usb;
const uint_least8_t adc_battery_current_CONST = adc_battery_current;
...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    /* Owned by i2c_imu as SDA */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL, /* CONFIG_GPIO_i2c_imu_SDA */
    /* Owned by i2c_imu as SCL */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL, /* CONFIG_GPIO_i2c_imu_SCL */
    /* Owned by i2s_mic as WS */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_GPIO_4 */
    /* Owned by i2s_mic as SD0 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_GPIO_1 */
    /* Owned by i2s_mic as SCK */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_GPIO_3 */
    GPIO_CFG_NO_DIR, /* DIO_9 */
    GPIO_CFG_NO_DIR, /* DIO_10 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_LOW | GPIO_CFG_OUT_LOW, /* gpio_on_sd */
    ...
    /* Owned by spi_sd as SD Slave Select */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_LOW | GPIO_CFG_OUT_HIGH, /* CONFIG_GPIO_0 */
    GPIO_CFG_NO_DIR, /* DIO_16 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_LOW | GPIO_CFG_OUT_LOW, /* gpio_led_status2 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_LOW | GPIO_CFG_OUT_HIGH, /* gpio_led_status1 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_LOW | GPIO_CFG_OUT_LOW, /* gpio_led_status0 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_LOW | GPIO_CFG_OUT_LOW, /* gpio_on_gps */
    /* Owned by uart_mu1 as TX */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* CONFIG_GPIO_uart_mu1_TX */
    /* Owned by uart_mu1 as RX */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_DOWN_INTERNAL, /* CONFIG_GPIO_uart_mu1_RX */
    ...
    /* Owned by adc_battery_level as ADC Pin */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_adc_battery_level_AIN */
    /* Owned by adc_battery_current as ADC Pin */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_adc_battery_current_AIN */
    /* Owned by adc_5V_usb as ADC Pin */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_adc_5V_usb_AIN */
};
...
const uint_least8_t CONFIG_GPIO_adc_battery_level_AIN_CONST = CONFIG_GPIO_adc_battery_level_AIN;
const uint_least8_t CONFIG_GPIO_adc_5V_usb_AIN_CONST = CONFIG_GPIO_adc_5V_usb_AIN;
const uint_least8_t CONFIG_GPIO_adc_battery_current_AIN_CONST = CONFIG_GPIO_adc_battery_current_AIN;
const uint_least8_t gpio_on_sd_CONST = gpio_on_sd;
const uint_least8_t gpio_on_gps_CONST = gpio_on_gps;
const uint_least8_t gpio_led_status0_CONST = gpio_led_status0;
const uint_least8_t gpio_led_status1_CONST = gpio_led_status1;
const uint_least8_t gpio_led_status2_CONST = gpio_led_status2;
const uint_least8_t CONFIG_GPIO_i2c_imu_SDA_CONST = CONFIG_GPIO_i2c_imu_SDA;
const uint_least8_t CONFIG_GPIO_i2c_imu_SCL_CONST = CONFIG_GPIO_i2c_imu_SCL;
...
const uint_least8_t CONFIG_GPIO_uart_mu1_TX_CONST = CONFIG_GPIO_uart_mu1_TX;
const uint_least8_t CONFIG_GPIO_uart_mu1_RX_CONST = CONFIG_GPIO_uart_mu1_RX;
...
const I2CCC26XX_HWAttrsV1 i2cCC26xxHWAttrs[CONFIG_I2C_COUNT] = {
    /* i2c_imu */
    {
        ...
        .intPriority = (~0),
        .swiPriority = 0,
        .sclPin      = CONFIG_GPIO_i2c_imu_SCL,
        .sclPinMux   = IOC_PORT_MCU_I2C_MSSCL,
        .sdaPin      = CONFIG_GPIO_i2c_imu_SDA,
...
const I2C_Config I2C_config[CONFIG_I2C_COUNT] = {
    /* i2c_imu */
    {
        .object      = &i2cCC26xxObjects[i2c_imu],
        .hwAttrs     = &i2cCC26xxHWAttrs[i2c_imu]
    },
};

const uint_least8_t i2c_imu_CONST = i2c_imu;
...
const I2SCC26XX_HWAttrs i2sCC26XXHWAttrs[CONFIG_I2S_COUNT] = {
    /* i2s_mic */
    {
        .pinSD1      =  CONFIG_GPIO_2,
        .pinSD0      =  CONFIG_GPIO_1,
        .pinSCK      =  CONFIG_GPIO_3,
        .pinMCLK     =  GPIO_INVALID_INDEX,
        .pinWS       =  CONFIG_GPIO_4,
        .intPriority =  (~0)
    }
};
...
const I2S_Config I2S_config[CONFIG_I2S_COUNT] = {
    /* i2s_mic */
    {
        .object      = &i2sCC26XXObjects[i2s_mic],
        .hwAttrs     = &i2sCC26XXHWAttrs[i2s_mic]
    },
};

const uint_least8_t i2s_mic_CONST = i2s_mic;
...
const SD_Config SD_config[CONFIG_SD_COUNT] = {
    /* spi_sd */
    {
        ...
        .object = &sdspiObjects[spi_sd],
        .hwAttrs = &sdspiHWAttrs[spi_sd]
    },
};

const uint_least8_t spi_sd_CONST = spi_sd;
...
static unsigned char uart2RxRingBuffer1[60];
/* TX ring buffer allocated to be used for nonblocking mode */
...
static const UART2CC26X2_HWAttrs uart2CC26X2HWAttrs[CONFIG_UART2_COUNT] = {
  ...
  },
  {
    ...
    .intPriority        = (~0),
    .rxPin              = CONFIG_GPIO_uart_mu1_RX,
    .txPin              = CONFIG_GPIO_uart_mu1_TX,
    .ctsPin             = GPIO_INVALID_INDEX,
    .rtsPin             = GPIO_INVALID_INDEX,
    .flowControl        = UART2_FLOWCTRL_NONE,
    ...
    .txIntFifoThr       = UART2CC26X2_FIFO_THRESHOLD_1_8,
    .rxIntFifoThr       = UART2CC26X2_FIFO_THRESHOLD_2_8
  },
};
...
const UART2_Config UART2_config[CONFIG_UART2_COUNT] = {
    ...
    {   /* uart_mu1 */
        .object      = &uart2CC26X2Objects[uart_mu1],
        .hwAttrs     = &uart2CC26X2HWAttrs[uart_mu1]
    },
};

const uint_least8_t CONFIG_UART2_0_CONST = CONFIG_UART2_0;
const uint_least8_t uart_mu1_CONST = uart_mu1;
