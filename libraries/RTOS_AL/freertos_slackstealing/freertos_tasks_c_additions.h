#include "freertos_custom/freertos_custom_defines.h"
//ensure only defines if its aviable
#ifdef RTOS_SSS
#include <freertos_custom/freertos_slackstealing/slack.h>
#endif
//#include "task.h"
/*****************************************************************************
...
BaseType_t xAlreadyYielded, xShouldDelay = pdFALSE;
    ...
    vTaskSuspendAll();
    {
        ...
        *pxPreviousWakeTime = xTimeToWake;
        ...
        #if ( configUSE_SLACK_STEALING == 1 )
        {
            if ( pxCurrentSsTCB->xTaskType == PERIODIC_TASK )
            {
...
void vSlackSchedulerSetup( void )
{
    ...
    {
       vApplicationNotSchedulable(); //COMMENT TO COMPILE
    }
