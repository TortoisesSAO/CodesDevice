...
public:
	...
	uint16_t begin(uint8_t agAddress = 0, uint8_t mAddress =0, uint8_t fifo_mode=1); //By default use the default I2C addres, and use Wire port
	...
	void readAll();//read all the data in the registers
