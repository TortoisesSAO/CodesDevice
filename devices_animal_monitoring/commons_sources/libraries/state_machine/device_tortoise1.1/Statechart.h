...
class SctEvent__battery_level : public TypedSctEvent<sc_boolean>
{
	public:
		SctEvent__battery_level(StatechartEventName name_, sc_boolean value_) :
...
class SctEvent__battery_level_critical : public SctEvent
{
	public:
		SctEvent__battery_level_critical(StatechartEventName name_) : SctEvent(name_){};
};
...
class SctEvent__sd_check_NOTok : public SctEvent
{
	public:
		SctEvent__sd_check_NOTok(StatechartEventName name_) : SctEvent(name_){};
};
...
class SctEvent__end_system : public SctEvent
{
	public:
		SctEvent__end_system(StatechartEventName name_) : SctEvent(name_){};
};
...
#define SCVI_SM_SD_CHECK 0
#define SCVI_SM_GPS_WAIT_POS_FIX 0
#define SCVI_SM_SD_NONC0NNECT 0
...
class Statechart : public sc::StatemachineInterface
{
	public:
		...
		/*! Raises the in event 'battery_level' that is defined in the default interface scope. */
		void raiseBattery_level(sc_boolean battery_level_);
		...
		/*! Raises the in event 'battery_level_critical' that is defined in the default interface scope. */
		void raiseBattery_level_critical();
		
		/*! Raises the in event 'sd_check_ok' that is defined in the default interface scope. */
		void raiseSd_check_ok();
		
		/*! Raises the in event 'sd_check_NOTok' that is defined in the default interface scope. */
		void raiseSd_check_NOTok();
		...
		/*! Raises the in event 'end_system' that is defined in the default interface scope. */
		void raiseEnd_system();
	...
	private:
		...
		/*! Raises the in event 'battery_level' that is defined in the default interface scope. */
		void internal_raiseBattery_level(sc_boolean battery_level_);
		sc_boolean battery_level_raised;
		sc_boolean battery_level_value;
		/*! Raises the in event 'battery_level_ok' that is defined in the default interface scope. */
		...
		/*! Raises the in event 'battery_level_critical' that is defined in the default interface scope. */
		void internal_raiseBattery_level_critical();
		sc_boolean battery_level_critical_raised;
		/*! Raises the in event 'sd_check_ok' that is defined in the default interface scope. */
		void internal_raiseSd_check_ok();
		sc_boolean sd_check_ok_raised;
		/*! Raises the in event 'sd_check_NOTok' that is defined in the default interface scope. */
		void internal_raiseSd_check_NOTok();
		sc_boolean sd_check_NOTok_raised;
		/*! Raises the in event 'gps_fixed_ok' that is defined in the default interface scope. */
		...
		/*! Raises the in event 'end_system' that is defined in the default interface scope. */
		void internal_raiseEnd_system();
		sc_boolean end_system_raised;
		/*! Raises the in event 'adq_check_battery' that is defined in the default interface scope. */
		...
		sc_integer SM_SD_CHECK_react(const sc_integer transitioned_before);
		sc_integer SM_GPS_WAIT_POS_FIX_react(const sc_integer transitioned_before);
		sc_integer SM_SD_NONC0NNECT_react(const sc_integer transitioned_before);
